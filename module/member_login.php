...
$l_Welcome      = $_lang == 'vn' ? 'Chào bạn đến với nhà sách' : 'Welcome';
...
<table border="1" width="100%" cellpadding="0" cellspacing="0" bordercolor="#666666" style="border-collapse:collapse">
	<tr>
		<td height="22">
			<span style="FONT-WEIGHT: 700; FONT-SIZE: 10pt;color:#333333">&nbsp;&nbsp;<?=$l_notmember?></span>
		</td>
	</tr>
...
<table border="1" width="100%" cellpadding="0" cellspacing="0" bordercolor="#000000" style="border-collapse:collapse">
	<tr>
		<td height="22">
			<span style="FONT-WEIGHT: 700; FONT-SIZE: 10pt; color:#333333">&nbsp;&nbsp;<?=$l_member?></span>
		</td>
	</tr>
	<tr>
		<td>
						...
						<table border="0" width="100%" cellpadding="0" cellspacing="0">
							...
							<tr>
								<td align="right"><a href="./?frame=forgotpass">
									<span style="color:#000000; text-decoration:none"><?=$l_ForgotPwd?></span></a></td>
								<td width="5"></td>
								<td>
