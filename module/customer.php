...
<tr>
	<td height="20" colspan="3" align="center" class="err" style="padding-top:5px">
		<span style="font-family:'Times New Roman', Times, serif; font-size:14px; color:#FF6600">
			<? if($errMsg!=''){echo '<p align=center class="err">'.$errMsg.'<br></p>';}?></span>
   </td>
</tr>
<tr>
...
<td nowrap width="60%"><INPUT class="fieldKey" size=33 name="txtFullname" value="<?=$fullname?>"></td>
</tr>
...
<td width="5">&nbsp;</td>
<td nowrap width="60%"><INPUT class="fieldKey" size=33 name="txtCompany" value="<?=$company?>"></td>
</tr>
...
<td width="5"><font color="#FF0000">*</font></td>
<td nowrap width="60%"><INPUT class="fieldKey" size=33 name="txtAddress" value="<?=$address?>"></td>
</tr>
<tr><td colspan="3" height="5px"></td></tr>
<tr>
...
<td width="5"><font color="#FF0000">*</font></td>
<td width="60%"><input class="fieldKey" size=33 name="txtTel" value="<?=$tel?>" /></td>
</tr>
<tr><td colspan="3" height="5px"></td></tr>
<tr>
<td align="right" class="normalfontbold" width="40%">E-mail</td>
<td width="5"> <font color="#FF0000">*</font></td>
<td nowrap width="60%"> <INPUT class="fieldKey" size=33 name="txtEmail" value="<?=$email?>"></td>
</tr>
<tr>
<td align="right" class="normalfontbold" width="40%">Fax</td>
<td width="5">&nbsp;</td>
<td nowrap width="60%"><INPUT class="fieldKey" size=33 name="txtFax" value="<?=$fax?>"></td>
</tr>
<tr><td colspan="3" height="5px"></td></tr>
<tr>
<td align="right" class="normalfontbold" width="40%">Website</td>
<td width="5">&nbsp;</td>
<td nowrap width="60%"> <INPUT class="fieldKey" size=33  name="txtWebsite" value="<?=$website?>"></td>
</tr>
