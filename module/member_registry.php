...
<? $errMsg =''?>
<?
$l_Request     = $_lang == 'vn' ? 'Thông tin phải nhập' : 'Request info';
			...
			<table align="center" border="1" width="100%" cellpadding="0" bordercolor="#FFFFFF" cellspacing="0" style="border-collapse:collapse">
				<tr>
					<td align="center">
						...
						<br><br>
						[ <a href="./"><?=$_lang=='vn'?'Kích vào đây để trở về trang chủ !.':'Login'?></a> ]
						<br><br>
					</td>
				</tr>
			</table>
...
<table border="0" cellspacing="5" cellpadding="0" width="100%" align="center">
	...
	<tr><td height="20" colspan="3" class="normalTitle"><b><?=$l_PerInfo?></b><HR size="1" noshade></td></tr>

	<tr>
		<td align="right" class="normalFont"><?=$l_Name?></td>
		<td><font color="#FF0000">*</font></td>
		<td><input class="textbox" size="30" name="txtName" value="<?=$name?>"></td>
	</tr>
	
	<tr>
		<td align="right" class="normalFont" width="35%"><?=$l_Sex?></td>
		<td width="7"><font color="#FF0000">*</font></td>
		<td><?=comboSex($sex,$_lang)?></td>
	</tr>
	
	<tr>
		<td align="right" class="normalFont"><?=$l_Company?></td>
		<td>&nbsp;</td>
		<td><input class="textbox" size="30" name="txtCompany" value="<?=$company?>"></td>
	</tr>


	<tr><td height="20" colspan="3" class="normalTitle"><b><?=$l_AddressInfo?></b><HR size="1" noshade></td></tr>


	<tr>
		<td align="right" class="normalFont"><?=$l_Address?></td>
		<td><font color="#FF0000">*</font></td>
		<td><input class="textbox" size="30" name="txtAddress" value="<?=$address?>"></td>
	</tr>

	<tr>
		<td align="right" class="normalFont"><?=$l_State?></td>
		<td><font color="#FF0000">*</font></td>
		<td><input class="textbox" size="30" name="txtCity" value="<?=$city?>"></td>
	</tr>

	<tr valign="middle" height="22">
		<td align="right" class="normalFont"><?=$l_Country?></td>
		<td><font color="#FF0000">*</font></td>
		<td>
	...
	<tr><td height="20" colspan="3" class="normalTitle"><b><?=$l_ContactInfo?></b><HR size="1" noshade></td></tr>

	<tr>
		<td align="right" class="normalFont"><?=$l_Tel?></td>
		<td><font color="#FF0000">*</font></td>
		<td><input class="textbox" size="30" name="txtTel" value="<?=$tel?>"></td>
	</tr>
	
	<tr>
		<td align="right" class="normalFont"><?=$l_Fax?></td>
		<td>&nbsp;</td>
		<td><input class="textbox" size="30" name="txtFax" value="<?=$fax?>"></td>
	</tr>
	
	<tr>
		<td align="right" class="normalFont"><?=$l_Email?></td>
		<td><font color="#FF0000">*</font></td>
		<td><input class="textbox" size="30" name="txtEmail" value="<?=$email?>"></td>
	</tr>
	
	<tr>
		<td align="right" class="normalFont"><?=$l_Website?></td>
		<td>&nbsp;</td>
		<td><input class="textbox" size="30" name="txtWebsite" value="<?=$website?>"></td>
	</tr>

	<tr><td height="20" colspan="3" class="normalTitle"><b><?=$l_UserInfo?></b><HR size="1" noshade></td></tr>

	<tr>
		<td align="right" class="normalFont"><?=$l_Uid?></td>
		<td class="Star"><font color="#FF0000">*</font></td>
		<td>
			<input class="textbox" size="30" name="txtUid" value="<?=$uid?>">
			<font color="#FFFFFF">(<?=$l_min4char?>)</font>
		</td>
	</tr>

	<tr>
		<td align="right" class="normalFont"><?=$l_Pwd?></td>
		<td><font color="#FF0000">*</font></td>
		<td>
	...
	<tr>
		<td align="right" class="normalFont"><?=$l_Pwd2?></td>
		<td class="Star"><font color="#FF0000">*</font></td>
		<td>
	...
	<tr><td height="20" colspan="3" class="normalTitle"><b><?=$l_strConfirm?></b><HR size="1" noshade></td></tr>
	
	<tr>
		<td align="right" class="normalFont"></td>
		<td class="Star"></td>
		<td>
			<input type="hidden" name="HidRd" id="HidRd" value="<? print( md5($rand)) ?>">
			<img name="robust" src= "<? print('lib/RD_Img.php?RD='.$randE) ?>" border="1" style="border-color:#999999; border-collapse:collapse">
		</td>
	</tr>
	
	<tr>
		<td align="right" class="normalFont"><?=$l_strR?></td>
		<td class="Star"></td>
		<td>
	...
	<tr>
		<td colspan="2"></td>
		<td>
			<input class="buttonorange" onmouseover="this.className='buttonblue'" style="WIDTH: 89px; HEIGHT: 22px" onmouseout="this.className='buttonorange'" type="submit" value="<?=$l_btnRegistry?>" name="btnRegistry" onclick="return btnRegistry_onclick()">
			<input type=reset class="buttonorange" onmouseover="this.className='buttonblue'" style="WIDTH: 89px; HEIGHT: 22px" onmouseout="this.className='buttonorange'" name=butReset value="<?=$l_btnReset?>">
		</td>
	</tr>
