...
<?
$alphanum  = "abcdefghijlmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789";
...
<table border="0" cellspacing="5" cellpadding="0" width="100%" align="center">
	<tr>
		<td height="20" colspan="3" class="normalfont" align="right">
			<font color="#FF0000">* </font><font color="#3D3D3D"><?=$l_Request?>&nbsp;&nbsp;&nbsp;</font>
		</td>
	</tr>

	<tr><td height="20" colspan="3" class="normalTitle"><?=$l_PerInfo?><HR size="1" noshade></td></tr>
	...
	<tr><td height="20" colspan="3" class="normalTitle"><?=$l_strConfirm?><HR size="1" noshade></td></tr>
	...
	<tr>
		...
		<td>
			...
			<img name="robust" src= "<? print('lib/RD_Img.php?RD='.$randE) ?>" width="120" height="70">
		</td>
	</tr>
	...
	<tr>
		<td align="center">
			<input class="buttonorange" onmouseover="this.className='buttonblue'" style="WIDTH: 120px; HEIGHT: 18px" onmouseout="this.className='buttonorange'" type="button" value="<?=$l_btnChangePwd?>" name="btnChangePwd" onclick="window.location='./?frame=changepassword'">
		</td>
		<td></td>
		<td>
			<input class="buttonorange" onmouseover="this.className='buttonblue'" style="WIDTH: 89px; HEIGHT: 18px" onmouseout="this.className='buttonorange'" type="submit" value="<?=$l_btnEdit?>" name="btnEdit" onclick="return btnEdit_onclick()">
			<input type=reset class="buttonorange" onmouseover="this.className='buttonblue'" style="WIDTH: 89px; HEIGHT: 18px" onmouseout="this.className='buttonorange'" name=butReset value="<?=$l_btnReset?>">
		</td>
	</tr>
