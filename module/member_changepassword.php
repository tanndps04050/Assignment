	...
	<tr>
		<td width="100%" align="center">
			<table border="0" cellpadding="2" bordercolor="#111111" width="100%" cellspacing="0">
				...
				<tr>
					<td align="right" class="smallfont" width="40%"><?=$l_Uid?></td>
					<td class="smallfont"><b><?=$_SESSION['member']?></b></td>
				</tr>
				<tr>
					<td align="right" class="smallfont"><?=$l_PwdOld?></td>
					<td class="smallfont"><input type="password" name="txtPwdOld" size="34"></td>
				</tr>
				<tr>
					<td align="right" class="smallfont"><?=$l_Pwd?></td>
					<td class="smallfont"><input type="password" name="txtPwdNew1" size="34"></td>
				</tr>
				<tr>
					<td align="right" class="smallfont"><?=$l_Pwd2?></td>
				...
				<tr>
					...
					<td width="100%" class="smallfont">
						<input class="buttonorange" onmouseover="this.className='buttonblue'" style="WIDTH: 120px; HEIGHT: 18px" onmouseout="this.className='buttonorange'" type="submit" name="btnChange" value="<?=$l_btnChangePwd?>" onClick="return btnChange_onClick()">
					</td>
				</tr>
				<tr><td colspan="2" height="10"></td></tr>
			</table>
