...
$l_sao      = $_lang == 'vn' ? 'Thông tin phải nhập' : 'Request info';
...
<table align="center" width="95%" cellpadding="0" cellspacing="0">
	<tr>
		...
		<font color="#ff0000"> * </font> <strong><?=$l_sao?></strong>
		</td>
	</tr>
	<tr><td align="center" style="padding-right:80px"><? if($errMsg!=''){echo '<p align=center class="err">'.$errMsg.'<br></p>';}?></td></tr>	
...
<table border="0" width="100%" cellspacing="1" cellpadding="0" style="border-collapse:collapse">
	...
	<tr>
		...
		<td width="30%" align="right" class="normalFont"><font color="#FF0000">*</font> <?=$l_hoten?> : </td>
	...
	<tr>
		<td align="right" class="normalFont"><?=$l_congty?> : </td>
		<td>&nbsp;<input class="textbox" size=30 name="txtCompany" value="<?=$company?>"></td>
	</tr>

	<tr>
		<td align="right" class="normalFont"><?=$l_diachi?> : </td>
		<td>&nbsp;<input class="textbox" size=30 name="txtAddress" value="<?=$address?>"></td>
	</tr>

	<tr>
		<td align="right" class="normalFont"><font color="#FF0000">*</font> <?=$l_email?> : </td>
	...
	<tr>
		<td align="right" class="normalFont"><?=$l_dt?> : </td>
		<td>&nbsp;<input class="textbox" size=30 name="txtTel" value="<?=$tel?>"></td>
	</tr>
	
	<tr>
		<td align="right" class="normalFont"><?=$l_dtdd?> : </td>
		<td>&nbsp;<input class="textbox" size=30 name="txtMobile" value="<?=$mobile?>"></td>
	</tr>
	...
	<tr>
	   <td align="right" class="normalFont"><font color="#FF0000">*</font> <?=$l_noidung?> &nbsp;</td>
	...
	<tr>
		<td align="center">
			...
			&nbsp;<input class="buttonOrange" onmouseover="this.className='buttonBlue'" onmouseout="this.className='buttonOrange'" type="submit" value="<?=$l_nutgoi?>" name="btnSend" style="height: 22px; width:100px" onclick="return btnSend_onclick()">

			&nbsp;<input class="buttonOrange" onmouseover="this.className='buttonBlue'" onmouseout="this.className='buttonOrange'" type="reset" value="<?=$l_nutxoa?>" name="btnReset" style="height: 22px; width:80px">
