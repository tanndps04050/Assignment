...
<form id="login" name="login" action="./" method="post">
					<table width="182" border="0" cellspacing="0" cellpadding="0">                                         
                        ...
                        <tr>
                          <td class="style11" style="padding-top:5px;"><a class="next2" href="#" onClick=" btnLogin_onclick();app.Submit(document.getElementById('login'), 'login2', event, app.CommonCallback)"><?=$l_btnLogin?></a> / <a href="./?frame=registry" style="text-decoration:none;" class="next2"><?=$l_btnRegistry?></a></td>
                        </tr>
                        <tr>
                          <td class="style11" style="padding-top:5px;"><u><a  class="next2" href="./?frame=forgotpass"><?=$l_ForgotPwd?></a></u> </td>
                        </tr>
                    </table>
</form>