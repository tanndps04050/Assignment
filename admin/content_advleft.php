<? // Config
$codeSelect = $multiLanguage == 0 ? "code='".$_lang."_advleft'" : "code='vn_advleft' or code='en_advleft'";
...
<table border="1" cellpadding="2" bordercolor="#C9C9C9" width="100%">
	<tr>
		...
		<th width="160" class="title"><a class="title" href="<?=getLinkSort(2)?>">Địa chỉ website</a></th>
		<th width="115" class="title"><a class="title" href="<?=getLinkSort(3)?>">Tên hiển thị</a></th>
		<th width="100" class="title"><a class="title" href="<?=getLinkSort(8)?>">Hình</a></th>
		<th width="80" class="title"><a class="title" href="<?=getLinkSort(10)?>">Thứ tự sắp xếp</a></th>
		<th width="100" class="title"><a class="title" href="<?=getLinkSort(11)?>">Không hiển thị</a></th>
		<th width="140" class="title"><a class="title" href="<?=getLinkSort(12)?>">Ngày tạo lập</a></th>
		<th width="141" class="title"><a class="title" href="<?=getLinkSort(13)?>">Lần hiệu chỉnh trước</a></th>
		<th width="63" class="title"><a class="title" href="<?=getLinkSort(14)?>">Ngôn ngữ</a></th>
	</tr>
