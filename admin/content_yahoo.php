<? // Config
$codeSelect = $multiLanguage == 0 ? "code='".$_lang."_yahoo'" : "code='vn_yahoo' or code='en_yahoo'";
...
<table border="1" cellpadding="2" bordercolor="#C9C9C9" width="100%">
	<tr>
		...
		<th width="29" class="title"><a class="title" href="<?=getLinkSort(1)?>">ID</a></th>
		<th width="152" class="title"><a class="title" href="<?=getLinkSort(2)?>">YM! ID</a></th>
		<th width="152" class="title"><a class="title" href="<?=getLinkSort(3)?>">Tên hiển thị</a></th>
		<th width="81" class="title"><a class="title" href="<?=getLinkSort(10)?>">Thứ tự sắp xếp</a></th>
		<th width="81" class="title"><a class="title" href="<?=getLinkSort(11)?>">Không hiển thị</a></th>
		<th width="181" class="title"><a class="title" href="<?=getLinkSort(12)?>">Ngày tạo lập</a></th>
		<th width="181" class="title"><a class="title" href="<?=getLinkSort(13)?>">Lần hiệu chỉnh trước</a></th>
		<th width="80" class="title"><a class="title" href="<?=getLinkSort(14)?>">Ngôn ngữ</a></th>
	</tr>
...
<table width="100%">
	...
	<tr><td class="smallfont"><?='Tổng số sách : <b>'.countRecord($tableConfig,$firstWhere).'</b>'?></td></tr>
</table>