...
<? if ($image!=''){ echo '<img border="0" src="../'.$image.'" width="100"><br><br>Hình ảnh';}?>								</td>																
								<td width="15%"></td>
							</tr>
				...
				<tr>
					<td width="15%" class="smallfont" align="right">Tên khách hàng: </td>
					<td width="1%" class="smallfont" align="center"><font color="#FF0000">*</font></td>
					<td width="83%" class="smallfont">
						<input value="<?=$name?>" type="text" name="txtName" class="textbox" size="50">					</td>
				</tr>
				<tr>
					<td width="15%" class="smallfont" align="right">Địa chỉ: </td>
					<td width="1%" class="smallfont" align="center"></td>
					<td width="83%" class="smallfont">
						<input value="<?=$code?>" type="text" name="txtCode" class="textbox" size="50">					</td>
				</tr>
				...
				<!--<tr>
					...
					<td width="1%" class="smallfont" align="center"></td>
					<td width="83%" class="smallfont"><textarea name="txtDetailShort" id="txtDetailShort" cols="80" rows="10"><?=$detail_short?>
					</textarea></td>
				</tr>
