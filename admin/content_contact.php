<? // Config
$codeSelect = $multiLanguage == 0 ? "code='".$_lang."_contact'" : "code='vn_contact' or code='en_contact'";
...
<table border="1" cellpadding="2" bordercolor="#C9C9C9" width="100%">
	<tr>
		...
		<th width="29" class="title"></th>
		<th width="193" class="title"><a class="title" href="<?=getLinkSort(3)?>">Tên</a></th>
		<th width="124" class="title"><a class="title" href="<?=getLinkSort(5)?>">Hotline</a></th>
		<th width="190" class="title"><a class="title" href="<?=getLinkSort(6)?>">Nội dung</a></th>		
		<th width="101" class="title"><a class="title" href="<?=getLinkSort(11)?>">Không hiển thị</a></th>
		<th width="150" class="title"><a class="title" href="<?=getLinkSort(12)?>">Ngày tạo lập</a></th>
		<th width="150" class="title"><a class="title" href="<?=getLinkSort(13)?>">Lần hiệu chỉnh trước</a></th>
	</tr>
