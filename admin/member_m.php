    	...
    	<td>
    		<table border="0" cellpadding="2" bordercolor="#111111" width="100%" cellspacing="0">
				...
				<tr>
        			...
        			<td width="83%" class="smallfont">
						<input value="<?=$company?>" type="text" name="txtCompany" class="textbox" size="60">
					</td>
      			</tr>
				...
				<tr>
        			...
        			<td width="1%" class="smallfont" align="center"><font color="#FF0000" size="2">*</font></td>
        			<td width="83%" class="smallfont">
						<input value="<?=$address?>" type="text" name="txtAddress" class="textbox" size="60">
					</td>
      			</tr>
				...
				<tr>
        			...
        			<td width="1%" class="smallfont" align="center"><font color="#FF0000" size="2">*</font></td>
        			<td width="83%" class="smallfont">
						<input value="<?=$city?>" type="text" name="txtCity" class="textbox" size="34">
					</td>
      			</tr>
				...
				<tr>
        			...
        			<td width="1%" class="smallfont" align="center"><font color="#FF0000" size="2">*</font></td>
        			<td width="83%" class="smallfont">
						<input value="<?=$tel?>" type="text" name="txtTel" class="textbox" size="34">
					</td>
      			</tr>
				...
				<tr>
        			...
        			<td width="1%" class="smallfont" align="center"></td>
        			<td width="83%" class="smallfont">
						<input value="<?=$fax?>" type="text" name="txtFax" class="textbox" size="34">
					</td>
      			</tr>
				...
				<tr>
        			...
        			<td width="1%" class="smallfont" align="center"><font color="#FF0000" size="2">*</font></td>
        			<td width="83%" class="smallfont">
						<input value="<?=$email?>" type="text" name="txtEmail" class="textbox" size="34">
					</td>
      			</tr>
				...
				<tr>
        			...
        			<td width="1%" class="smallfont" align="center"></td>
        			<td width="83%" class="smallfont">
						<input value="<?=$website?>" type="text" name="txtWebsite" class="textbox" size="34">
					</td>
      			</tr>
				...
				<tr>
        			...
        			<td width="1%" class="smallfont" align="center"><font color="#FF0000" size="2">*</font></td>
        			<td width="83%" class="smallfont">
						<input value="<?=$uid?>" type="text" name="txtUid" class="textbox" size="34">
					</td>
      			</tr>
				...
				<tr>
        			...
        			<td width="1%" class="smallfont" align="center"><font color="#FF0000" size="2">*</font></td>
        			<td width="83%" class="smallfont">
						<input value="<?=$pwd?>" type="password" name="txtPwd" class="textbox" size="34">
					</td>
      			</tr>
				...
				<tr>
        			...
        			<td width="1%" class="smallfont" align="center"><font color="#FF0000" size="2">*</font></td>
        			<td width="83%" class="smallfont">
						<input value="<?=$pwd2?>" type="password" name="txtPwd2" class="textbox" size="34">
					</td>
      			</tr>
