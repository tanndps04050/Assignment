...
<? if ($image!=''){ echo '<img border="0" src="../'.$image.'" width="100"><br><br>Hình ảnh';}?>								</td>	<!--<td width="40%" align="center" class="smallfont">
...
<? if ($image_large!=''){ echo '<img border="0" src="../'.$image_large.'" width="100"><br><br>Hình lớn';}?>								</td>-->
				...
				<tr>
					...
					<td width="83%" class="smallfont">
						<input value="<?=$name?>" type="text" name="txtName" class="textbox" size="70">					</td>
				</tr>
				...
				<tr>
					...
					<td width="1%" class="smallfont" align="center"></td>
					<td width="83%" class="smallfont">						  
						<textarea name="txtDetailShort" cols="80" rows="10" id="txtDetailShort"><?=$detail_short?></textarea>
					 </td>
				</tr>
				...
				<tr>
					...
					<td width="1%" class="smallfont" align="center"></td>
					<td width="83%" class="smallfont">
						<?=comboCategory('ddCat',getArrayNews($tableCategoryConfig),'smallfont',$parent,0)?>					</td>
				...
				<tr>
					...
					<td width="83%" class="smallfont">
						<input value="<?=$sort?>" type="text" name="txtSort" class="textbox" size="12">					</td>
