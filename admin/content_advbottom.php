<? // Config
$codeSelect = $multiLanguage == 0 ? "code='".$_lang."_advbottom'" : "code='vn_advbottom' or code='en_advbottom'";
...
<table border="1" cellpadding="2" bordercolor="#C9C9C9" width="100%">
	<tr>
		...
		<th width="190" class="title"><a class="title" href="<?=getLinkSort(2)?>">Địa chỉ website</a></th>
		<th width="170" class="title"><a class="title" href="<?=getLinkSort(3)?>">Tên hiển thị</a></th>
		<th width="90" class="title"><a class="title" href="<?=getLinkSort(8)?>">Hình</a></th>
		<th width="100" class="title"><a class="title" href="<?=getLinkSort(10)?>">Thứ tự sắp xếp</a></th>
		<th width="111" class="title"><a class="title" href="<?=getLinkSort(11)?>">Không hiển thị</a></th>
