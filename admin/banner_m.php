...
if (isset($_POST['btnSave'])){
	...
	$errMsg .= checkUpload($_FILES["txtImage"],".jpg;.gif;.bmp;.png;.flv;.swf",10240*50240,0);
	$errMsg .= checkUpload($_FILES["txtImageLarge"],".jpg;.gif;.bmp;.png",5024*1024,0);
...
<? if ($image!=''){ echo '<b>Hình ảnh :  </b>'. $image;'<br><br>Hình ảnh Hoặc Flash';}?>
								</td>
							<td width="15%"></td>
							</tr>
							<? }else{echo '<tr><td colspan="3" class="smallfont" align="center"></td></tr>';}?>
				...
				<tr>
					...
					<td width="83%" class="smallfont">
						<input value="<?=$name?>" type="text" name="txtName" class="textbox" size="34" readonly>
					</td>
				</tr>
				<tr>
        			<td width="15%" class="smallfont" align="right">Link website</td>
        			<td width="1%" class="smallfont" align="center"></td>
        			<td width="83%" class="smallfont">
				...
				<tr>
					...
					<td width="83%" class="smallfont">
						...
						<span style="font-family:Tahoma; font-size:12px; font-weight:600">(Kích thước : 571 X 450 )</span>
					</td>
				</tr>
				<tr>
				...
				<!--<tr>
					...
					<td width="83%" class="smallfont">
						<input value="<?=$sort?>" type="text" name="txtSort" class="textbox" size="15">
					</td>
				</tr>-->
