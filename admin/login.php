...
if (isset($_POST['btnLogin'])){
	...
	//echo $sql;
	//echo mysql_num_rows(mysql_query($sql,$conn)) ;
...
<table width="800" border="0" align="center" cellpadding="0" cellspacing="0">
    ...
    <tr>
      ...
      <td width="786"><table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td height="40" align="center"><? if($errMsg!=''){echo '<p align=center class="err">'.$errMsg.'<br>&nbsp;</p>';}?></td>
        </tr>
        <tr>
          <td align="center"><table width="500" border="0" align="center" cellpadding="0" cellspacing="0">
            ...
            <tr>
              ...
              <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                  ...
                  <tr align="left">
                    <td colspan="2" class="font_bule">Vietnext Administrator Login </td>
                  </tr>
                  <tr align="left">
