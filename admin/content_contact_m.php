...
<? if ($image_large!=''){ echo '<img border="0" src="../'.$image_large.'" width="100"><br><br>Hình (kích thước lớn)';}?>
				...
				<tr>
					...
					<td width="83%" class="smallfont">
						<input readonly value="<?=$name?>" type="text" name="txtName" class="textbox" size="34">	</td>
				</tr>
				<tr><td height="10px"></td></tr>
				<tr>
					<td width="15%" class="smallfont" align="right">Hotline</td>
					<td width="1%" class="smallfont" align="center"></td>
					<td width="83%" class="smallfont"><textarea name="txtSubject" cols="80" rows="10" id="txtSubject"><?=$subject?>
					</textarea></td>
				</tr>								
				<tr><td height="10px"></td></tr>
				<tr>
				...
				<tr>
					...
					<td width="1%" class="smallfont" align="center"></td>
					<td width="83%" class="smallfont">
						<?=comboCategory('ddCat',$arraySourceCombo,'smallfont',$parent,0)?>					</td>
				</tr>
