...
<table border="1" cellpadding="2" bordercolor="#C9C9C9" width="100%">
	<tr>
	  <th width="31" class="title"><input type="checkbox" name="chkall" onClick="chkallClick(this);"></th>
		<th width="30" class="title"></th>
		<th width="136" class="title"><a class="title" href="<?=getLinkSort(3)?>">Tên</a></th>
		<!--<th width="155" class="title"><a class="title" href="<?=getLinkSort(5)?>">Nội dung ngắn</a></th>-->
		<th width="110" class="title"><a class="title" href="<?=getLinkSort(6)?>">Nội dung </a></th>
		<!--<th width="20" class="title"><a class="title" href="<?=getLinkSort(8)?>">Hình ảnh</a></th>-->
		<th width="88" class="title"><a class="title" href="<?=getLinkSort(11)?>">Không hiển thị</a></th>
		<th width="112" class="title"><a class="title" href="<?=getLinkSort(12)?>">Ngày tạo lập</a></th>
		<th width="114" class="title"><a class="title" href="<?=getLinkSort(13)?>">Lần hiệu chỉnh trước</a></th>
		<th width="65" class="title"><a class="title" href="<?=getLinkSort(14)?>">Ngôn ngữ</a></th>
	</tr>
...
while($row=mysql_fetch_array($result)){
	...
	<tr>
		...
		<td bgcolor="<?=$color?>" class="smallfont" align="center">
			<a href="./?act=<?=$actConfig ?>_m&cat=<?=$_REQUEST['cat']?>&page=<?=$_REQUEST['page']?>&id=<?=$row['id']?>">Sửa</a>
		</td>
