...
<table border="1" cellpadding="2" bordercolor="#C9C9C9" width="100%">
	<tr>
	  <th width="31" class="title"><input type="checkbox" name="chkall" onClick="chkallClick(this);"></th>
		...
		<th width="36" class="title"><a class="title" href="<?=getLinkSort(1)?>">ID</a></th>		
		<th width="220" class="title"><a class="title" href="<?=getLinkSort(3)?>">Tên tin tức</a></th>	
		<th width="100" class="title"><a class="title" href="<?=getLinkSort(6)?>">Nội dung </a></th>		
		<th width="80" class="title"><a class="title" href="<?=getLinkSort(8)?>">Hình ảnh</a></th>		
		<th width="70" class="title"><a class="title" href="<?=getLinkSort(10)?>">Thứ tự </a></th>
		<th width="90" class="title"><a class="title" href="<?=getLinkSort(11)?>">Không hiển thị</a></th>
