<? // Config
$codeSelect = $multiLanguage == 0 ? "code='".$_lang."_banner'" : "code='vn_banner' or code='en_banner'";
...
<table border="1" cellpadding="2" bordercolor="#C9C9C9" width="100%">
	<tr>
	  <th width="32" class="title"><input type="checkbox" name="chkall" onClick="chkallClick(this);"></th>
		<th class="title"></th>
		<th width="38" class="title"><a class="title" href="<?=getLinkSort(1)?>">ID</a></th>
		<th width="206" class="title"><a class="title" href="<?=getLinkSort(2)?>">Link website</a></th>
		<!--<th width="155" class="title"><a class="title" href="<?=getLinkSort(3)?>">Tên </a></th>-->
		<th width="110" class="title"><a class="title" href="<?=getLinkSort(8)?>">Hình ảnh</a></th>
		<th width="137" class="title"><a class="title" href="<?=getLinkSort(10)?>">Thứ tự sắp xếp</a></th>
		<th width="139" class="title"><a class="title" href="<?=getLinkSort(11)?>">Không hiển thị</a></th>
		<th width="225" class="title"><a class="title" href="<?=getLinkSort(12)?>">Ngày tạo lập</a></th>
		<th width="243" class="title"><a class="title" href="<?=getLinkSort(13)?>">Lần hiệu chỉnh trước</a></th>
		<th width="116" class="title"><a class="title" href="<?=getLinkSort(14)?>">Ngôn ngữ</a></th>
	</tr>
