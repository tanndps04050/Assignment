<? // Config
$codeSelect = $multiLanguage == 0 ? "code='".$_lang."_advright'" : "code='vn_advright' or code='en_advright'";
...
<table border="1" cellpadding="2" bordercolor="#C9C9C9" width="100%">
	<tr>
		...
		<th width="115" class="title"><a class="title" href="<?=getLinkSort(2)?>">Địa chỉ website</a></th>
		<th width="91" class="title"><a class="title" href="<?=getLinkSort(3)?>">Tên hiển thị</a></th>
		<th width="32" class="title"><a class="title" href="<?=getLinkSort(8)?>">Hình</a></th>
