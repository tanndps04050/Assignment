...
<table border="1" cellpadding="2" style="border-collapse: collapse" bordercolor="#C9C9C9" width="100%">
	<tr>
		...
		<th width="309" class="title"><a class="title" href="<?=getLinkSort(2)?>">Tên S&#7843;n ph&#7849;m</a></th>
		<th width="100" class="title"><a class="title" href="<?=getLinkSort(3)?>">Thứ tự sắp xếp</a></th>
		<th width="100" class="title"><a class="title" href="<?=getLinkSort(4)?>">Không hiển thị</a></th>
		<th width="127" class="title"><a class="title" href="<?=getLinkSort(5)?>">Ngày tạo lập</a></th>
		<th width="126" class="title"><a class="title" href="<?=getLinkSort(6)?>">Lần hiệu chỉnh trước</a></th>
