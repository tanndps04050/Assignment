<? // Config
$codeSelect = $multiLanguage == 0 ? "code='".$_lang."_skype'" : "code='vn_skype' or code='en_skype'";
...
<table border="1" cellpadding="2" bordercolor="#C9C9C9" width="100%">
	<tr>
		...
		<th width="203" class="title"><a class="title" href="<?=getLinkSort(2)?>">Skype ID</a></th>
		<th width="193" class="title"><a class="title" href="<?=getLinkSort(3)?>">Tên hiển thị</a></th>
		<th width="76" class="title"><a class="title" href="<?=getLinkSort(10)?>">Thứ tự sắp xếp</a></th>
		<th width="80" class="title"><a class="title" href="<?=getLinkSort(11)?>">Không hiển thị</a></th>
		<th width="150" class="title"><a class="title" href="<?=getLinkSort(12)?>">Ngày tạo lập</a></th>
		<th width="144" class="title"><a class="title" href="<?=getLinkSort(13)?>">Lần hiệu chỉnh trước</a></th>
		<th width="60" class="title"><a class="title" href="<?=getLinkSort(14)?>">Ngôn ngữ</a></th>
	</tr>
